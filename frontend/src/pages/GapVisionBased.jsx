...
// Vision Based
// Vision-based health monitoring (lameness, body condition, distress signals from video)
...
export default function GapVisionBased() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Vision-based health monitoring (lameness, body condition, distress signals from video)</p>
