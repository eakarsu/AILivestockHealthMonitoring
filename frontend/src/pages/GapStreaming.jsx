...
// Streaming
// Streaming biosecurity monitor across herds with quarantine recommendations
...
export default function GapStreaming() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Streaming biosecurity monitor across herds with quarantine recommendations</p>
