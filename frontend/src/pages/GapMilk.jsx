...
// Milk
// Milk buyer reporting integration

export default function GapMilk() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-milk', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Milk</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Milk buyer reporting integration</p>
