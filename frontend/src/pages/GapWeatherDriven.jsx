...
// Weather Driven
// Weather-driven heat-stress alerts (no weather route)

export default function GapWeatherDriven() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-weather-driven', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Weather Driven</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Weather-driven heat-stress alerts (no weather route)</p>
      ...
      <div style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: 8, padding: 20, marginBottom: 20 }}>
        ...
        <div style={{ marginTop: 12, display: 'flex', gap: 8 }}>
          ...
          >
            {loading ? 'Running...' : 'Run Weather Driven'}
          </button>
          <button
