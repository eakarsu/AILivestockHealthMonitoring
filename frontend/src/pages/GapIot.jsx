...
// Iot
// IoT sensor integration (temperature, humidity, smart scales)

export default function GapIot() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-iot', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Iot</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>IoT sensor integration (temperature, humidity, smart scales)</p>
