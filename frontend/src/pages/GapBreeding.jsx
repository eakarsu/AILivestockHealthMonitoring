...
// Breeding
// Breeding optimization agent with inbreeding coefficient tracking

export default function GapBreeding() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-breeding', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Breeding</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Breeding optimization agent with inbreeding coefficient tracking</p>
