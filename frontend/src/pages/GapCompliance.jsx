...
// Compliance
// Compliance & traceability automation for antibiotic stewardship
...
export default function GapCompliance() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Compliance & traceability automation for antibiotic stewardship</p>
