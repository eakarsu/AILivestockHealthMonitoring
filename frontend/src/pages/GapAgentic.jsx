...
// Agentic
// Agentic herd health advisor (vaccination schedules, dosing, seasonal risks)
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic herd health advisor (vaccination schedules, dosing, seasonal risks)</p>
