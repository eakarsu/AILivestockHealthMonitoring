...
// Feature: Compliance
// Description: Compliance docs (RFID tags, certifications) workflow
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Compliance. Compliance docs (RFID tags, certifications) workflow' },
